...
require 'rubygems'
require 'csv'
Dir.foreach('Userdata/select_userdata2009/') do |user_name|
  next if user_name == '.' or user_name == '..'
  data = CSV.read('Userdata/select_userdata2009/' + user_name, col_sep: ",")
  result_hash = {}
  data.each do|record|
  ...
  CSV.open("countingdata/" + user_name ,"w") do |csvobject|
